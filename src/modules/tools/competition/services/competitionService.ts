...
import { IProductsList, ProductsListSchema } from "../models/CompetitionProdsModel";
...
export async function GetProductsList() {
  try {
    ...
    const DB_ProductsListModel =
      db.models.ProductsList || db.model<IProductsList>("ProductsList", ProductsListSchema);
